        ...
        <Container className="relative">
          <div className="mx-auto max-w-2xl">
            ...
            <div className="mt-8 divide-y divide-black/[0.08] sm:mt-10">
              {givingCategories.map((category) => (
                <a
                  ...
                  className="group flex items-center justify-between gap-4 py-5 transition-colors duration-300 hover:text-gold-dark sm:py-6"
                >
            ...
            <div className="mt-10 rounded-2xl border border-black/[0.06] bg-white px-5 py-7 text-center sm:mt-16 sm:p-10">
              ...
              <p className="mt-3 text-sm font-semibold tracking-wider text-gold-dark">
                2 CORINTHIANS 9:7
              </p>
            </div>
          </div>
