...
const fallbackIcons = [HiClock, HiCalendar, HiUserGroup, HiLocationMarker];
        ...
        <div className="grid grid-cols-2 gap-2.5 min-[375px]:gap-3 sm:gap-4 lg:grid-cols-4 lg:gap-6">
          {snapshots.map((item, index) => (
            <motion.div
              ...
              className="group flex items-center gap-2.5 min-[375px]:gap-3 sm:gap-4 bg-white/80 backdrop-blur-md border border-black/6 px-3 py-3 min-[375px]:px-4 sm:px-5 sm:py-4 shadow-sm transition-all duration-500 hover:border-gold-dark/20 hover:shadow-md"
            >
              <div className="flex h-9 w-9 min-[375px]:h-10 min-[375px]:w-10 sm:h-11 sm:w-11 shrink-0 items-center justify-center bg-gold-dark/10 text-gold-dark transition-all duration-500 group-hover:bg-gold group-hover:text-navy">
